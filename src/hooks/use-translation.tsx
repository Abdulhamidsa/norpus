...
const translations = {
  en: {
    ...
    "about.story.paragraph3": "Our commitment to modern development practices ensures your website is not only fast and reliable today, but also future-ready for tomorrow's challenges.",
    ...
    "about.values.subtitle": "The technical excellence and professional principles that define our development process.",
  ...
  da: {
    ...
    "about.story.paragraph3": "Vores engagement i moderne udviklingspraksis sikrer, at din hjemmeside ikke kun er hurtig og pålidelig i dag, men også fremtidsklar til morgendagens udfordringer.",

    "about.mission.title": "Vores Mission",
    "about.mission.description": "At levere exceptionelle webløsninger, der kombinerer banebrydende teknologi med omhyggelig opmærksomhed på klientkrav. Vi fokuserer på at skabe hurtige, skalerbare og vedligeholdelige hjemmesider, der driver forretningssucces.",

    "about.vision.title": "Vores Vision",
    "about.vision.description": "At blive anerkendt som den førende udviklingspartner for virksomheder, der søger professionelle, moderne webløsninger bygget med teknisk ekspertise og ægte klientsamarbejde.",

    "about.values.title": "Vores Ekspertise",
    "about.values.subtitle": "Den tekniske ekspertise og professionelle principper, der definerer vores udviklingsproces.",

    "about.values.modern.title": "Moderne Teknologi",
    "about.values.modern.description": "Vi udnytter de nyeste udviklingsframeworks og værktøjer til at bygge hurtige, sikre og skalerbare webapplikationer.",

    "about.values.professional.title": "Teknisk Ekspertise",
    "about.values.professional.description": "Vores udviklingsteam bringer dyb teknisk viden og branchens bedste praksis til hvert projekt.",

    "about.values.listening.title": "Klient Samarbejde",
